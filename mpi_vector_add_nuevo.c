...
//vectores random
void Random_vector(double local_a[], int local_n, int n, char vec_name[], int my_rank, MPI_Comm comm);
//extras
...
#  endif
   ...
   Random_vector(local_x, local_n, n, "x", my_rank, comm);
   Print_vector(local_x, local_n, n, "x is", my_rank, comm);
   Random_vector(local_y, local_n, n, "y", my_rank, comm);
   Print_vector(local_y, local_n, n, "y is", my_rank, comm);

//empezanr tiempo para ser objetivo
   empezado = MPI_Wtime();
//incializamos calculos
   Parallel_vector_sum(local_x, local_y, local_z, local_n);
//tiempo finalizado
   finalizado = MPI_Wtime();
//calculo
   tiempo += finalizado-empezado;
//print suma
